package com.cloud.dinein.cli;

import com.cloud.dinein.DineInConfiguration;
...
public class RenderCommand extends ConfiguredCommand<DineInConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<DineInConfiguration> bootstrap,
                       Namespace namespace,
                       DineInConfiguration configuration) throws Exception {
